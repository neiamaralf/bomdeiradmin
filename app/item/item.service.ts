...
export class ItemService {
    ...
    constructor(userService: UserService) {
        ...
        else if (userService.user.super == 2) {
            this.items.push(
                {
                    id: 1, name: "SHOWS", menu: new Array<Item>(
                        { id: 5, name: "REGIÃO", menu: new Array<Item>() },
                        { id: 6, name: "ESTILO", menu: new Array<Item>() },
                ...
                },
                {
                    id: 2, name: "TEATROS", menu: new Array<Item>(
                        ...
                        { id: 11, name: "ESTILO", menu: new Array<Item>() },
                ...
                },
                {
                    id: 3, name: "EXPOSIÇÕES", menu: new Array<Item>(
                        ...
                        { id: 16, name: "ESTILO", menu: new Array<Item>() },
                ...
                },
                {
                    id: 4, name: "CINEMAS", menu: new Array<Item>(
                        ...
                        { id: 21, name: "ESTILO", menu: new Array<Item>() },
